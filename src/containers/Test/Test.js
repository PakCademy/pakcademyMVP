...
function Test(props) {
  ...
  useEffect(() => {
    axios
      .post("http://localhost:8080/get-test", {
        topic: "PHYSICS",
      })
      .then((res) => {
        console.log(res);
        const questionnaire_snap = res.data.test;
  ...
  const handleSubmit = () => {
    axios
      .post("http://localhost:8080/get-result", {
      ...
      .then((res) => {
        console.log(res);
        props.history.push(
          "/result/" + res.data.score + "/" + questionnaire.length
        );
      })
      .catch((err) => {
        console.log(err);
        ...
        <div className="test-column test-column--middle">
          <div className="test-header">
            <div className="test-header--topic">
              <h3 className="test-header--topic-text">Physics</h3>
            </div>
